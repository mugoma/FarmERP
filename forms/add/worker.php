...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($surname_err) && empty($other_names_err)){
        ...
        $sql = "INSERT INTO erp_workers (surname, other_names) VALUES ($1, $2)";
        ...
        if($stmt = pg_prepare($link,'stmt_insert', $sql)){            
            ...
            if(pg_execute($link, 'stmt_insert',array($param_surname, $param_other_names))){
                $surname= $other_names="";
        ...
        <main>
            <div class="wrapper container">
                ...
                <div class="form-group ">
                        ...
                        <input type="text" name="surname" class="form-control <?= (!empty($surname_err)) ? 'is-invalid' : ''; ?>" value="<?= $surname; ?>" id='name'>
                        <span class="invalid-feedback"><?= $surname_err ?></span>
                    </div>
                    <div class="form-group ">
                        <label for='other_names'>Other Names *</label>
                        <input type="text" name="other_names" class="form-control <?= (!empty($other_names_err)) ? 'is-invalid' : ''; ?>" value="<?= $other_names; ?>" id='other_names'>
                        <span class="invalid-feedback"><?= $other_names_err ?></span>
                    </div>
                    <div class="form-group">
