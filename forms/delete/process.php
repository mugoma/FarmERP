...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Delete Process<?=" | Forms | ".SOFTWARE_NAME ?></title>
            ...
            <div class="wrapper container">
                ...
                <form  id='form' method="post">
                    <div class="form-group ">
                        ...
                        <select class="form-control select_multiple <?= (!empty($process_id_err)) ? 'is-invalid' : ''; ?>" id="process" name="process_id" required>
