...
$product= $amount=$quantity=$notes=$name=$product_id="";
$product_err = $amount_err=$quantity_err=$notes_err="";

$product_querry=pg_query($link, "SELECT id, name, grows FROM erp_product WHERE (purchase ='true')");
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(test_input($_POST["product_id"])) || test_input($_POST["product_id"])+0 < 0){
        $product_err = "Please select a valid product". var_dump($_POST["product_id"]);     
    }else{
        $id='';
    ...
    if(
        ...
        pg_query($link, 'BEGIN;');
        $sql_1 = "INSERT INTO erp_purchase (product_id, amount, quantity, notes) VALUES ($1, $2,$3,$4)";
        $sql_2 = "INSERT INTO erp_product_quantity_records (name,quantity,transaction_type) VALUES ($1, $2,$3)";
        $sql_3 = $sql_4 = $grows= '';

        $sql_5="INSERT INTO erp_cashbook (folio, amount, transaction_type) VALUES($1, $2, 'Cr');";
        ...
        if(
            ...
            $execute_3='';
            $execute_4='';
            $execute_5=pg_execute($link, 'stmt_insert_5', array($param_product_quantity_name, $param_amount));
            if ($grows==false){
            ...
            <div class="wrapper container">
                ...
                <form  method="post">
                    ...
                    <div class="form-group <?php echo (!empty($amount_err)) ? 'has-error' : ''; ?>">
                        ...
                        <input type="text" name="amount" class="form-control" value="<?php echo $amount; ?>" id='name'>
